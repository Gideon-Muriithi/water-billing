                                ...
                                <tbody>
                                     <?php
                                        ...
                                        if ($result) {
                                            ...
                                            $user_id = $row["id"];
                                            $sql2 = "SELECT * FROM `bills` WHERE `user_id`='$user_id'";
                                            ...
                                            if ($results) {
                                                ...
                                                while ($row2 = mysqli_fetch_array($results)) {
                                                    echo "<tr>";
                                                        ...
                                                        echo "<td>".number_format($row2["previous_charges"])."</td>";
                                                        echo "<td>".number_format($row2["current_charges"])."</td>";
                                                        echo "<td>".number_format($row2["current_charges"]+$row2["previous_charges"])."</td>";
