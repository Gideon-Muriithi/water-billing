  ...
  <body>
    <div class="row">
          ...
          <div class="sidebar main-sidenav">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
              <div class="image">
                ...
                <img src="../images/avatar.png" height="50px" class="img-circle elevation-2" alt="User Image">
              </div>
              <div class="info">
                ...
                <a href="#"><i class="fa fa-circle text-success ml-1"></i><span class="nav-item">Online</span></a>
              </div>
            </div>
            <hr>
      ...
      <div class="col-md-9 col9">
        ...
        <div class="home">
          <p>Welcome to your water billing System. We're here to make things easier for you.</p>
        </div>
