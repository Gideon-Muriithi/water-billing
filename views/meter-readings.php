                ...
                <div class="">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title mt-3 text-center">Monthly Units Consumed</h3>
                        </div>
                            ...
                            <table
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">Dispute Current Units</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                        ...
                                        if ($result) {
                                            ...
                                            $user_id = $row["id"];
                                            $sql2 = "SELECT * FROM `meter_readings` WHERE `user_id`='$user_id'";
                                            ...
                                            if ($results) {
                                                ...
                                                while ($row2 = mysqli_fetch_array($results)) {
                                                    echo "<tr>";
                                                        ...
                                                        echo "<td>".$row2["previous_units"]."</td>";
                                                        echo "<td>".$row2["current_units"]."</td>";
                                                        echo "<td>".$row2["current_units"]-$row2["previous_units"]."</td>";
                                                        echo "<td>"."<a class='btn btn-primary btn-sm' href='../handles/dispute_units.php?id=".$row2['id']."'
                                                                        >Dispute</a>"."</td>";
