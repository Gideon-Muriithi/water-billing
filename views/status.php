                ...
                <div class="">
                    <div class="box">
                        <div class="box-header mt-3 text-center">
                            <h3 class="box-title">Status of the Account</h3>
                        </div>
                        ...
                        <div class="box-body">
                            <table
                                ...
                                <thead>
                                    <tr>
                                        <th scope="col">#</th>
                                        <th scope="col">Account Meter Number</th>
                                        <th scope="col">Sewer Connection</th>
                                        <th scope="col">Water Connection</th>
                                ...
                                <tbody>
                                        ...
                                        if ($result) {
                                            ...
                                            $user_id = $row["id"];
                                            $sql2 = "SELECT * FROM `account_status` WHERE `user_id`='$user_id'";
                                            ...
                                            if ($results) {
                                                ...
                                                while ($row2 = mysqli_fetch_array($results)) {
                                                    echo "<tr>";
                                                        echo "<td>"."$num"."</td>";
                                                        echo "<td>".$row2["meter_number"]."</td>";
                                                        echo "<td>".$row2["sewer_connection"]."</td>";
                                                        echo "<td>".$row2["water_connection"]."</td>";
                                                        echo "<td>".$row2["account_cat"]."</td>";
                                                        echo "<td>".$row2["account_status"]."</td>";
