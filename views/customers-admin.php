            ...
            <div class="col-md-9 col9">
                ...
                <?php 
                        ...
                        echo "<div class='col-sm-12'>";
                            echo "<div class='card mr-2'>";
                                echo "<div class='card-header d-inline'>";
                                    echo "<span class='card-title h4'>All Customers</span>";
                        ...
                        if (mysqli_num_rows($results) > 0) {
                            ...
                            while ($row = mysqli_fetch_array($results)) {
                                echo "<tr>";
                                    ...
                                    echo "<td><a href='../handles/customer_update.php?id=".$row['id']."'><i
                                        class='fa fa-pencil-square-o text-info h6'
                                                aria-hidden='true'></i></a>";
                                    
                                    //  data-toggle='modal' data-target='#delete'

                                    echo "<a href='../handles/account_deletion.php?id=".$row['id']."'
                            ...
                            echo "</div>";
                                ...
                                echo "<p class='ml-4 mt-3 text-danger'>No customer records found</p>";
                            }
                        }else {
                    ...
                    mysqli_close($link);
                     ...
                     if (isset($_GET["get_id"]) and !empty($_GET["get_id"])) {
                ...
                <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <form action="../handles/add-customers.php" method="post">
                                <div class="modal-body">
                                    <input type="hidden" name="customers_id" id="" value="">
                                    <div class="modal-body">
                                        <label for="AccountNumber">Account Number</label>
                                        <input type="number" class="form-control" name="AccountNumber" id="" required>
                                    </div>
                                    <div class="modal-body">
                                        <label for="AccountName">Account Name</label>
                                        <input type="text" class="form-control" name="AccountName" id="" required>
                                    </div>
                                    <div class="modal-body">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <input type="number" class="form-control" name="IdNumber" id="" required>
                                    </div>
                                    <div class="modal-body">
                                        <label for="sys-user">User</label>
                                        <select name="sys-user" id="sys-user" class="form-control">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" id="des" cols="20" rows="5"
                                            class="form-control"></textarea>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                    <button name="add-customer" type="submit" class="btn btn-primary">Save </button>
                                </div>
                            </form>
                        </div>
                    </div>
