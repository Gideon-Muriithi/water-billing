            ...
            <div class="col-md-9 col9">
                ...
                <div class="">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <table
                                class="table table-striped table-bordered table-hover table-dark table-responsive-lg id=table">
                                <thead>
                                    <tr>
                                        <th scope="col">#</th>
                                    ...
                                    <?php
                                        ...
                                        if ($result) {
                                            ...
                                            if ($results) {
                                                ...
                                                echo "<tr>";
                                                    echo "<td>"."1"."</td>";
                                                    echo "<td>".$row2["AccountNumber"]."</td>";
                                                    echo "<td>".$row2["AccountName"]."</td>";
                                                    echo "<td>".$row2["PhoneNumber"]."</td>";
                                                    echo "<td>".$row2["IdNumber"]."</td>";
                                                echo "</tr>";
                                            }
                                        }
