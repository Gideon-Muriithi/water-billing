                ...
                <div class="">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title mt-3 text-center">Disputed Current Units</h3>
                        </div>
                            ...
                            <table
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">Customer Units</th>
                                        <th scope="col">System Units</th>
                                        <th scope="col">Units Difference</th>
                                        <th class="mr-2" scope="col">Confirm</th>
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $sql = "SELECT * FROM `disputed_units`";
                                        $results = mysqli_query($link, $sql);                                      
                                        ...
                                        if ($results) {
                                            ...
                                            while ($row = mysqli_fetch_array($results)) {
                                                echo "<tr>";
                                                    ...
                                                    echo "<td>".$row["customer_units"]."</td>";
                                                    echo "<td>".$row["system_units"]."</td>";
                                                    echo "<td>".$row["system_units"]-$row["customer_units"]."</td>";
                                                    echo "<td>"."<a href='../handles/units_update.php?id=".$row['id']."'
                                                            class=' text-success h4 text-center'><i class='fa fa-check-circle' 
